...
import torch
from .common import MLP, ResNet18, ResNet18_TinyImagenet, ResNet18_TinyImagenet_Independent
...
class Net(torch.nn.Module):
    def __init__(self, n_inputs, n_outputs, n_tasks, args):
        ...
        for t in range(n_tasks):
            self.opts.append(
                torch.optim.SGD(self.nets[t].parameters(), lr=args.lr))
